...
export const ROLES = {
  'website-reader': {
    ...
    permissions: [
      ...
      ...scope('website', 'documents', ['read']),
      ...scope('website', 'videos', ['read']),
      ...scope('website', 'faqs', ['read']),
      ...scope('website', 'faq-tags', ['read']),
  ...
  'website-editor': {
    ...
    permissions: [
      ...
      ...scope('website', 'documents', ['create', 'read', 'update']),
      ...scope('website', 'videos', ['create', 'read', 'update']),
      ...scope('website', 'faqs', ['create', 'read', 'update']),
      ...scope('website', 'faq-tags', ['create', 'read', 'update']),
  ...
  'website-admin': {
    name: 'Website Admin',
    description: 'Full control over website content',
    permissions: [
      ...scope('system', 'adminPanel', ['read']),
      ...
      ...scope('website', 'documents', 'all'),
      ...scope('website', 'videos', 'all'),
      ...scope('website', 'faqs', 'all'),
      ...scope('website', 'faq-tags', 'all'),
      ...scope('website', 'story-categories', 'all'),
      ...scope('website', 'redirects', 'all'),
