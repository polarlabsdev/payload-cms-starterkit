  ...
  (
    ...
    React.useEffect(() => {
      ...
      const intervalId = setInterval(() => {
        if (canAutoScroll && canScrollNext) {
          api.scrollNext();
        }
    ...
    }, [autoplay, api, autoplayInterval, canAutoScroll, canScrollNext]);
    ...
    return (
      ...
      >
        <div
          ref={ref}
          onMouseEnter={() => setCanAutoScroll(false)}
          onMouseLeave={() => setCanAutoScroll(true)}
