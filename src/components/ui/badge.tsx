...
export interface BadgeProps
  ...
  badgeColor?: BrandColorKey;
  textColor?: BrandColorKey;
}

function Badge({ className, variant, badgeColor, textColor, style, ...props }: BadgeProps) {
  // Handle brand variant styling
  let brandStyle: React.CSSProperties = {};
  if (variant === 'brand') {
    const bgColor = badgeColor ? BRAND_COLORS[badgeColor] : BRAND_COLORS.Teal;
